...
tags:
  ...
  - 案例
publish: true
prompt: A TV box glowing with teal AI connections, acting as a remote arm for a powerful Mac mini brain, distributed node concept with dark background and neural network lines
